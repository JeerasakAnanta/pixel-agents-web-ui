...
import {
  ...
  CHAR_FRAMES_PER_ROW,
  WALL_BITMASK_COUNT,
} from '@pixel-agents/core/assets/constants.js';
import type {
  FurnitureAsset,
  FurnitureManifest,
  InheritedProps,
...
import {
  ...
  parseWallPng,
  pngToSpriteData,
} from '@pixel-agents/core/assets/pngDecoder.js';
import type { CharacterDirectionSprites } from '@pixel-agents/core/assets/types.js';
import * as fs from 'fs';
import * as path from 'path';
import type * as vscode from 'vscode';
export type { CharacterDirectionSprites } from '@pixel-agents/core/assets/types.js';
