...
import { JSONL_POLL_INTERVAL_MS } from '@pixel-agents/server/constants.js';
import {
  ensureProjectScan,
  readNewLines,
  reassignAgentToFile,
  startFileWatching,
} from '@pixel-agents/server/fileWatcher.js';
import { loadLayout } from '@pixel-agents/server/layoutPersistence.js';
import { CLAUDE_TERMINAL_NAME_PREFIX } from '@pixel-agents/server/providers/hook/claude/constants.js';
import { claudeProvider } from '@pixel-agents/server/providers/index.js';
import { cancelPermissionTimer, cancelWaitingTimer } from '@pixel-agents/server/timerManager.js';
import type { AgentState, PersistedAgent } from '@pixel-agents/server/types.js';
